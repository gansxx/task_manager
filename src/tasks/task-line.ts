...
import { getCurrentTimestamp, getDatePart, type TimestampPrecision } from "../utils/date";
...
export function appendTaskComment(line: string, comment: string, precision: TimestampPrecision = "date"): string {
  const parsed = parseTaskLine(line);
